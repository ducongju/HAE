...
class AssociativeEmbedding(BasePose):
    ...
    def forward(self,
        ...
        Args:
            ...
            return_tagmap  (bool) : Option to return tagmap. 
        ...
        return self.forward_test(
            img, img_metas, return_heatmap=return_heatmap, return_tagmap=return_tagmap,**kwargs)
    ...
    def forward_test(self, img, img_metas, return_heatmap=False, return_tagmap=False,**kwargs):
        ...
        if return_tagmap:
            output_tagmap = aggregated_tags.detach().cpu().numpy()
        else:
            output_tagmap = None
        ...
        result['output_tagmap'] = output_tagmap
